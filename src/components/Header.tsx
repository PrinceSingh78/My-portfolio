  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white/95 dark:bg-gray-900/95 
                        backdrop-blur-md border-b border-gray-200/20 dark:border-gray-700/20">
